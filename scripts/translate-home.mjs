...
function needsTranslation(
  ...
  /*
   * If the target text is exactly the same as the
   * English source, treat it as untranslated.
   *
   * Some technical and brand names may legitimately
   * stay the same, but translating them again is safe.
   */
  if (
    cleanExisting === sourceText.trim()
  ) {
    return true
  }
