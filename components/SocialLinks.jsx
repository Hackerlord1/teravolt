...
const SocialLinks = () => {
  ...
  return (
    <div className="fixed left-6 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center">
      {/* Vertical line above */}
      <div className="w-px h-16 bg-gray-400/50 mb-4" />
      ...
      <div className="flex flex-col items-center gap-5">
        {socials.map((social) => (
          ...
          >
            {/* Icon */}
            <div className="w-5 h-5 fill-gray-400 transition-all duration-300 group-hover:fill-white group-hover:scale-110">
              {social.icon}
            </div>

            {/* Tooltip label on hover */}
            <span className="absolute left-8 whitespace-nowrap bg-gray-900/90 text-white text-xs px-3 py-1.5 rounded-md opacity-0 pointer-events-none transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-1 backdrop-blur-sm border border-gray-700/50">
              {social.label}
            </span>
          </a>
        ))}
      ...
      {/* Vertical line below */}
      <div className="w-px h-16 bg-gray-400/50 mt-4" />
    </div>
  );
};
